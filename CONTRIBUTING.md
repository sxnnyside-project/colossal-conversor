# Contributing to Colossal Conversor
...
```
feat: add native in-process PPM to BMP transcoder
fix: prevent crash when output folder is not writable
docs: update architecture overview for v4 native runtime
