...
If you find a security vulnerability in **Colossal Conversor**, report it privately before disclosing it publicly.
...
This policy covers the **Colossal-Conversor** repository only.
